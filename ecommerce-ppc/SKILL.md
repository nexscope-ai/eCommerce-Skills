...
This skill provides strategic planning and creative direction based on industry benchmarks and product analysis. It cannot access live ad platform data, create actual images/videos, set up tracking pixels, or manage ad accounts directly. For deeper platform-specific optimization with live data integration, stay tuned for **[Nexscope](https://github.com/nexscope-ai)**.

---

**Part of the [Nexscope](https://github.com/nexscope-ai) suite — AI-powered e-commerce tools.**
